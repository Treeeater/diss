...
\footnotetext{Works done after our paper was published.}
...
\begin{figure}[hbt]
\centering
\includegraphics[width=.5\textwidth]{figures/chapter3/liveAccessToken}
...
\begin{figure}[hbt]
\centering
\includegraphics[width=.5\textwidth]{figures/chapter3/liveAccessToken2}
...
\begin{figure}[hbt]
\centering
\includegraphics[width=.7\textwidth]{figures/chapter3/systemModules}
...
\begin{figure}[hbt]
\centering
\includegraphics[width=.7\textwidth]{figures/chapter3/explicatingThreatModel}
...
\lstinputlisting[caption={Example Facebook PHP SDK code},label={lst:exampleFacebookPHPSDKCode}]{listings/phpModel.php}
\lstinputlisting[caption={Example Facebook PHP SDK model},label={lst:exampleFacebookPHPSDKModel}]{listings/phpModel.bgl}
...
\input{tables/explicatingCriticalAssumptions}
...
\input{tables/explicatingOtherAssumptions}
